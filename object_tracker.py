...
flags.DEFINE_string('classes', r'F:\152\vehicle\yolov3_deepsort_lane_detection-master\data\labels\coco.names', 'path to classes file')
flags.DEFINE_string('weights', './weights/yolov3.tf',
                    'path to weights file')
flags.DEFINE_boolean('tiny', False, r'F:\152\vehicle\yolov3_deepsort_lane_detection-master\weights\yolov3-tiny.weights')
flags.DEFINE_integer('size', 416, 'resize images to')
flags.DEFINE_string('video', r'F:\152\vehicle\yolov3_deepsort_lane_detection-master\data\video\test_sample.mp4',
...
def main(_argv):
    ...
    model_filename = r'F:\152\vehicle\yolov3_deepsort_lane_detection-master\model_data\mars-small128.pb'
